...
namespace Ch07Ex01TracePoints {
    class Program {
        ...
        static int Maxima(int[] integers, out int[] indices) {
            ...
            //Debug.WriteLine(string.Format($"Maximum value initialised to {maxVal}, at element index 0."));
            ...
            //Trace.WriteLine(string.Format($"Maximum value {maxVal} found, with {count} occurances."));
